...
--
-- Хост: localhost:8889
-- Время создания: Мар 02 2021 г., 15:49
...
INSERT INTO `category` (`id`, `name`, `css_class`) VALUES
...
INSERT INTO `city` (`id`, `title`, `latitude`, `longitude`) VALUES
...
INSERT INTO `message` (`id`, `message`, `sender_id`, `reciever_id`, `task_id`, `published_at`) VALUES
(12, '12', 21, 1, 2, '2020-11-10 19:27:01'),
(13, 'как дела', 1, 21, 2, '2020-11-10 20:38:05'),
(14, 'sdf', 21, 1, 2, '2020-11-11 15:36:40'),
(23, '123', 21, 1, 2, '2020-11-11 15:49:50'),
(24, '1', 21, 1, 2, '2020-11-11 15:52:27'),
(25, '1', 21, 1, 2, '2020-11-11 15:54:45'),
(26, 'йцу', 21, 1, 2, '2020-11-12 05:55:36'),
(27, '111', 21, NULL, 1, '2021-01-26 15:24:21');
...
('m000000_000000_base', 1593065202),
('m130524_201442_init', 1604779119),
('m190124_110200_add_verification_token_column_to_user_table', 1604779119),
('m200606_201551_fill_usersRole_table', 1593065205),
('m200613_143616_role_id_for_users_id', 1593275828),
('m200617_202108_add_status_to_task_status', 1593275828),
('m200704_205908_task_respond_add_status', 1593944492),
('m200715_053235_add_task_status_new_status', 1594791413),
('m201107_134123_add_task_id_column_to_message_table', 1604779402),
('m201110_053644_add_is_mine_column_to_message_table', 1604987159),
('m201110_055547_add_published_at_column_to_message_table', 1605036413),
('m201123_204435_create_user_setting_table', 1606422737),
('m201124_152400_create_user_subscription_table', 1606422737),
('m201124_153603_create_user_specialization_table', 1606550849),
('m201126_213527_create_user_settings_specialization_id_to_user_specialization_table', 1606550849),
('m201128_102312_create_specialization_id_to_user_id_and_user_category_id', 1606596946),
('m201202_054318_fill_user_specialization_table', 1606888335),
('m201207_194814_user_contacts_fill_data', 1607372307),
('m201208_195140_add_columns_to_notification', 1607457846),
('m201208_200523_create_links_for_notification', 1607545275),
('m201216_054625_fill_user_specialization_table', 1608097877),
('m201218_204009_user_notification_fix_links', 1608485221),
('m201225_052329_user_files_fill_table', 1609746797),
('m210103_210522_user_avatar_fix_table', 1609791496),
('m210201_203605_user_add_new_fields_for_oauth', 1612296073);
...
INSERT INTO `reviews` (`id`, `description`, `raiting`, `created`, `price`, `status_id`, `account_id`) VALUES
(1, 'desc', 4.25, '2020-06-25 09:06:22', 1500, 1, 6),
(2, 'bad executor', 1, '2020-06-25 09:06:22', 2500, 1, 6),
(3, 'normal executor!', 3, '2020-06-25 09:06:22', 3500, 1, 6),
(4, 'exelent executor!', 5, '2020-06-25 09:06:22', 4500, 1, 6),
(5, 'there is no cow level', 4, '2020-06-25 09:06:22', 1500, 1, 1),
(6, 'Im can do it', 2, '2020-06-25 09:06:22', 500, 2, 1),
(7, 'Take all tasks', 3, '2020-06-25 09:06:22', 3000, 3, 3),
(8, 'like hard-work', 5, '2020-06-25 09:06:22', 4500, 1, 4);
...
INSERT INTO `task` (`id`, `title`, `description`, `address`, `latitude`, `longitude`, `price`, `deadline`, `created`, `city_id`, `executor_id`, `owner_id`, `status_id`, `category_id`) VALUES
(1, 'enable impactful technologies', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', '1 Eagan Crossing', '6.9641667', '158.2083333', 6587, '2019-11-15 00:00:00', '2019-03-09 00:00:00', NULL, NULL, 4, 1, 2),
(2, 'exploit revolutionary portals', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.\r\n    Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', '24043 Paget Alley', '5.623505', '10.2544044', 2904, '2019-12-07 00:00:00', '2019-07-03 00:00:00', NULL, 1, 21, 3, 3),
(3, 'matrix next-generation e-commerce', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.\r\n    Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.\r\n    Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', '2867 Dryden Pass', '63.593219', '53.9068532', 1170, '2019-11-23 00:00:00', '2019-06-27 00:00:00', NULL, 1, 8, 3, 2),
(4, 'benchmark plug-and-play infomediaries', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.\r\n    Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.\r\n    Fusce consequat. Nulla nisl. Nunc nisl.', '80 Cambridge Street', '20.5800358', '-75.2435307', 838, '2019-11-10 00:00:00', '2019-01-01 00:00:00', NULL, NULL, 9, 1, 1),
(5, 'integrate cross-platform e-business', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', '1 Stone Corner Junction', '14.9326574', '-91.6941845', 7484, '2019-12-15 00:00:00', '2019-09-07 00:00:00', NULL, NULL, 7, 1, 3),
(6, 'enable dot-com niches', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', '12 Stephen Terrace', '40.163127', '116.638868', 5725, '2019-11-24 00:00:00', '2018-11-01 00:00:00', NULL, NULL, 12, 1, 7),
(7, 'transform web-enabled relationships', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', '6213 Lake View Drive', '44.3794871', '20.2638941', 4414, '2019-11-19 00:00:00', '2019-09-13 00:00:00', NULL, NULL, 14, 1, 5),
(8, 'strategize frictionless solutions', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.\r\n    Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.\r\n    Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.', '994 Corry Park', '-7.3251485', '108.3607464', 3454, '2019-11-14 00:00:00', '2019-04-01 00:00:00', NULL, NULL, 16, 1, 8),
(9, 'innovate seamless metrics', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', '2 Bluestem Park', '43', '-87.97', 3101, '2019-12-12 00:00:00', '2019-03-28 00:00:00', NULL, NULL, 18, 1, 4),
(10, 'integrate wireless infomediaries', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.', '1 Dexter Hill', '41.3410168', '-8.3169303', 6562, '2019-12-19 00:00:00', '2019-05-01 00:00:00', NULL, NULL, 20, 1, 4),
(11, 'test', 'test', '3', '0', '0', 55555, '2020-06-19 00:00:00', '2020-06-30 18:58:31', NULL, 1, 1, 1, 3),
(12, 'test', 'tteesstt', '3', '0', '0', 5, '2020-07-02 00:00:00', '2020-06-30 19:00:24', NULL, 1, 1, 1, 4),
(13, 'test', 'test', 'Агрыз', '0', '0', 555, '2020-08-12 00:00:00', '2020-08-23 22:13:02', 6, 1, 1, 1, 6),
(14, 'test', 'ttttt', 'Калуга', '36.261215', ' 54.513845', 5555, '2020-08-21 00:00:00', '2020-08-24 09:08:14', 359, 1, 1, 1, 4),
(15, 'ttt', 'ttt', 'Алзамай', '98.664357', ' 55.555072', 4, '2020-09-24 00:00:00', '2020-09-09 08:27:46', 22, 1, 1, 1, 5),
(16, 'rrr', 'rrr', 'Алексеевка', '38.688095', ' 50.629961', 4, '2020-10-06 00:00:00', '2020-09-09 08:48:51', 20, 1, 1, 1, 4),
(17, 'tttК', 'к', 'Александровск-Сахалинский', '142.158915', ' 50.895768', 4, '2020-09-22 00:00:00', '2020-09-09 08:55:44', 19, 1, 1, 1, 7),
(18, 'y', 'y', 'Брянск', '34.363407', ' 53.243562', 4, '2020-09-23 00:00:00', '2020-09-09 09:11:00', 131, 1, 1, 1, 4);
...
INSERT INTO `task_file` (`id`, `image_path`, `task_id`) VALUES
(1, 'myWorks.png', 1),
(2, 'documentation.docx', 1),
(3, 'salary.xls', 1),
(4, 'my_picture.jpeg', 2),
(5, 'agreement.docx', 2),
(6, 'ру_название.docx', 2),
(7, 'ру название с пробелами.docx', 2),
(8, 'brands.docx', 3),
(9, 'my_pic.jpeg', 4),
(10, 'documentation.docx', 4),
(11, 'intro.docx', 5),
(12, 'myPassportList.jpeg', 6),
(13, 'myPassportAvatar.jpeg', 7),
(14, 'myPassportImage.jpeg', 8),
(15, 'myPassportPic.jpeg', 9),
(16, 'myPassportPicture.jpeg', 10),
(17, 'physical.png', 11),
(18, 'legal.png', 12);
...
--
-- Структура таблицы `task_respond`
--
...
--
-- Дамп данных таблицы `task_respond`
--

INSERT INTO `task_respond` (`id`, `comment`, `price`, `datetime`, `user_id`, `task_id`, `status_id`) VALUES
(1, 'Могу сделать все в лучшем виде', 1500, '2020-07-05 13:21:32', 1, 2, 3),
(2, 'Примусь за выполнение в течении часа', 1500, '2020-07-05 13:21:32', 3, 2, 1),
(3, 'Забацаю любое задание! Быстро и в срок!', 4500, '2020-07-05 13:21:32', 3, 2, 1),
(4, '1', 1, '2020-07-12 16:16:03', 8, 2, 3);
...
CREATE TABLE `users` (
  ...
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `about` text,
  `visit` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(4, 'emollon3@bloglovin.com', 'Emalee Mollon', 'XUIeJ693h', 'Sesame', '2020-06-25 09:06:10', '2018-11-13 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(5, 'mmulberry4@cmu.edu', 'Maria Mulberry', 'oWspnl', 'Sesame', '2020-06-25 09:06:10', '2019-07-20 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(6, 'lby5@mozilla.com', 'Levey By', 'GdtcUU', 'Sesame', '2020-06-25 09:06:10', '2019-02-12 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(7, 'beates6@last.fm', 'Baron Eates', 'UQw6VeA', 'Sesame', '2020-06-25 09:06:10', '2019-05-03 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(8, 'tvink7@fotki.com', 'Trip Vink', '49znXd7haFGz', 'Sesame', '2020-06-25 09:06:10', '2019-01-13 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(9, 'bterbeck8@about.me', 'Boonie Terbeck', 'unCjJTF7sjs', 'Sesame', '2020-06-25 09:06:10', '2019-09-15 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(10, 'atraviss9@auda.org.au', 'Alonzo Traviss', 'dLuVMAg', 'Sesame', '2020-06-25 09:06:10', '2018-12-19 00:00:00', '\r\n                                добавляют фракционных разногласий и рассмотрены исключительно\r\n          ', '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(11, 'nwitteringa@google.com.br', 'Natassia Wittering', 'tQlUG4n', 'Sesame', '2020-06-25 09:06:10', '2019-03-24 00:00:00', 'v', '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(12, 'fbrookeb@nba.com', 'Felice Brooke', 's9y9Mcfgy1g', 'Sesame', '2020-06-25 09:06:10', '2019-09-27 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(13, 'cviccaryc@amazon.co.uk', 'Carlen Viccary', '9qd747vh', 'Sesame', '2020-06-25 09:06:10', '2018-12-06 00:00:00', 'Сложно сказать', '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(14, 'hgethingsd@sogou.com', 'Hendrik Gethings', 'zzN5c4', 'Sesame', '2020-06-25 09:06:10', '2018-11-18 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(15, 'dgirodiase@stanford.edu', 'Dunc Girodias', 'j9QW6GQI', 'Sesame', '2020-06-25 09:06:10', '2018-10-14 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(16, 'btanmanf@smh.com.au', 'Bibbie Tanman', '1aukKNEIneq', 'Sesame', '2020-06-25 09:06:10', '2019-05-03 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(17, 'bbartolettig@simplemachines.org', 'Barnabas Bartoletti', '3chTNtqhoo', 'Sesame', '2020-06-25 09:06:10', '2018-12-25 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(18, 'nculliph@fc2.com', 'Nixie Cullip', '2UdKIR2f', 'Sesame', '2020-06-25 09:06:10', '2019-04-07 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(19, 'mpimblotti@xing.com', 'Matilde Pimblott', 'nGZ8disdg', 'Sesame', '2020-06-25 09:06:10', '2019-07-18 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(20, 'askurrayj@un.org', 'Al Skurray', 'bL9tAf', 'Sesame', '2020-06-25 09:06:10', '2018-11-25 00:00:00', NULL, '2020-06-25 09:06:10', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL),
(21, 'test@test.ru', 'test2', '', NULL, '2010-06-25 00:00:00', '2020-06-25 22:46:51', 'about21_about text 1112121', '2021-03-02 17:30:34', 0, 0, 0, 0, NULL, 553, 3, NULL, 2, 4, NULL, NULL, NULL),
(27, 'Elelion@yandex.ru', 'Александр Гинц', '489fe5', NULL, '2021-02-08 22:19:59', '2021-02-08 22:19:59', NULL, '2021-03-01 18:23:19', 0, 0, 0, 0, NULL, NULL, NULL, NULL, 2, NULL, 'I5EqFYc4Wq3FTre6mlkgXfyF0UYIzigU', 'naRqz2tFuRrlxbf0ACCj9BV_yg2uD2iq_1612811999', NULL);
...
--
-- Дамп данных таблицы `users_avatar`
--

INSERT INTO `users_avatar` (`id`, `image_path`, `account_id`) VALUES
(11, 'man-glasses.jpg', 4),
(12, 'man-glasses.jpg', 1),
(13, 'man-glasses.jpg', 20),
(23, 'man-hat.png', 21);
...
INSERT INTO `users_category` (`id`, `account_id`, `category_id`) VALUES
(1, 21, 1),
(2, 21, 5),
(3, 1, 6),
(4, 1, 8);
...
INSERT INTO `users_contacts` (`id`, `phone`, `skype`, `messanger`, `account_id`) VALUES
(3, '9996665544', 'skype1', 'messanger1', 21);
...
CREATE TABLE `users_favorites` (
  `id` int(11) NOT NULL,
  `favorites_account_id` int(11) DEFAULT NULL,
  `account_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
--
-- Дамп данных таблицы `users_image`
--

INSERT INTO `users_image` (`id`, `image_path`, `account_id`) VALUES
(2, 'man-glasses.jpg', 21),
(3, 'user-man.jpg', 21);
...
INSERT INTO `users_roles` (`id`, `title`, `key_code`) VALUES
...
INSERT INTO `user_notification` (`id`, `user_id`, `notification_type`, `active`) VALUES
(2, 21, 3, 0),
(5, 21, 1, 1),
(6, 21, 2, 0),
(7, 21, 4, 1);
...
INSERT INTO `user_specialization` (`id`, `user_id`, `category_id`) VALUES
(2, 1, 1),
(4, 3, 3),
(7, 20, 2),
(9, 20, 1),
...
ALTER TABLE `message`
  ...
  ADD KEY `fk_message_task_id_column_to_message_table` (`task_id`);
...
--
-- Индексы таблицы `task_respond`
--
ALTER TABLE `task_respond`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `users`
  ...
  ADD KEY `fk_notifications_to_user_id` (`notification_id`);

--
-- Индексы таблицы `users_avatar`
--
ALTER TABLE `users_avatar`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_avatar_to_user_id` (`account_id`);
...
ALTER TABLE `users_contacts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_contacts_account_id_column_to_users_id` (`account_id`);

--
-- Индексы таблицы `users_favorites`
--
ALTER TABLE `users_favorites`
  ADD PRIMARY KEY (`id`),
  ADD KEY `favorites_account_id` (`favorites_account_id`),
  ADD KEY `account_id` (`account_id`);

--
-- Индексы таблицы `users_image`
--
...
ALTER TABLE `user_notification`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_users_notification_id_to_user_notification_id` (`user_id`);
...
ALTER TABLE `user_specialization`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_user_specialization_to_user_specialization_id` (`user_id`),
  ADD KEY `fk_users_specialization_to_user_category_id` (`category_id`);
...
--
-- AUTO_INCREMENT для таблицы `task_respond`
--
ALTER TABLE `task_respond`
...
--
-- AUTO_INCREMENT для таблицы `users_avatar`
--
ALTER TABLE `users_avatar`
...
--
-- AUTO_INCREMENT для таблицы `users_favorites`
--
ALTER TABLE `users_favorites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `users_image`
--
ALTER TABLE `users_image`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`),
  ADD CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`),
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `fk_message_task_id_column_to_message_table` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`),
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`sender_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `message_ibfk_2` FOREIGN KEY (`reciever_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `reviews`
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `task_status` (`id`);
...
ALTER TABLE `task`
  ...
  ADD CONSTRAINT `task_ibfk_2` FOREIGN KEY (`executor_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `task_ibfk_3` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `task_ibfk_4` FOREIGN KEY (`status_id`) REFERENCES `task_status` (`id`),
  ADD CONSTRAINT `task_ibfk_5` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `task_respond`
--
ALTER TABLE `task_respond`
  ADD CONSTRAINT `task_respond_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `task_respond_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `users_avatar`
--
ALTER TABLE `users_avatar`
  ADD CONSTRAINT `fk_user_avatar_to_user_id` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `users_category`
--
ALTER TABLE `users_category`
  ADD CONSTRAINT `users_category_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
  ADD CONSTRAINT `users_category_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `users_contacts`
--
ALTER TABLE `users_contacts`
  ADD CONSTRAINT `fk_contacts_account_id_column_to_users_id` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `users_favorites`
--
ALTER TABLE `users_favorites`
  ADD CONSTRAINT `users_favorites_ibfk_1` FOREIGN KEY (`favorites_account_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `users_favorites_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `users_image`
--
ALTER TABLE `users_image`
  ADD CONSTRAINT `users_image_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `user_notification`
--
ALTER TABLE `user_notification`
  ADD CONSTRAINT `fk_users_notification_id_to_user_notification_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `user_specialization`
--
ALTER TABLE `user_specialization`
  ADD CONSTRAINT `fk_user_specialization_to_user_specialization_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fk_users_specialization_to_user_category_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);
